...
import CountdownTimer from "@/screens/workout/CountdownTimer";
import Status from "@/screens/workout/Status";
import WorkoutOrderModal from "@/screens/workout/WorkoutOrderModal";
...
const StartComponent = memo(({ workoutData }: StartComponentProps) => {
	...
	const workoutOrder = useMemo(
		() => getWorkoutOrder(timers, exercises),
		[timers, exercises],
	);
